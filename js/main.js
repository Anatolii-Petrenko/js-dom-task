const content = [
  ...
  },
  {
    ...
    description:
      "Espresso coffee originated with the invention of the espresso machine. The first espresso machine was a bulk brewer invented in 1884 in Turin by Angelo Moriondo. The first single-serve espresso machine was patented in 1901 by Luigi Bezzera, and was put into production by the Pavoni company in 1905.\n\nEspresso coffee is made by forcing hot water through fine ground coffee at 9 bars of pressure. Espresso is a strong, concentrated coffee that makes it a great base for milk coffees.",
  },
  {
    id: 3,
    menuItem: "Americano",
    ...
    description:
      "Americano is a hot coffee drink made with espresso and hot water. The Americano originated during World War 2, where American soldiers added hot water to espresso to help extend their coffee rations. It’s also said that they were not used to the strong taste of the local espresso coffee./n/nAmericano coffee is made by pulling a shot of espresso into a large cup, then topping it with hot water. It has a less-concentrated taste than espresso but more complex tasting notes than drip coffee.",
  },
  {
    id: 4,
    menuItem: "Cortado",
    img: "/img/cortado.png",
    description:
      "Cortado coffee is a hot coffee made from equal parts of espresso and steamed milk. It originates in the Basque region of Spain, but the exact history and age are unknown. Cortado spread to the United States in the 1960s, where it became known as Gibraltar and is also popular in Latin American countries.\n\nCortado is made by pulling a single shot of espresso in a small glass then adding an equal amount of steamed milk, with no foam. This coffee drink has a strong taste that is well-balanced by the milk.",
  },
  {
    id: 5,
    menuItem: "Red Eye",
  ...
  },
  {
    ...
    description:
      'Macchiato is a variation to a simple espresso shot. Macchiato is believed to date back to the 1980s in Italy. The story says that baristas would add a small dollop of foam to help waiters distinguish between plain espresso and espresso with a small amount of milk added.\n\nA macchiato, also known as "espresso macchiato", is prepared by adding a small amount of steamed milk or milk foam to a shot of espresso. Unlike some other coffee drinks, there is no standard recipe, and the preparation varies from place to place. It has a strong taste of espresso, which is tempered slightly by milk.\nThis coffee drink also has a latte variation called the "latte macchiato".',
  },
  {
    id: 8,
    menuItem: "Flat White",
    ...
    description:
      "Flat white is yet another recently invented coffee drink. The first documented reference to the modern flat white coffee dates back to 1983 in Sydney, Australia, mentioned in the Miller’s Treat cafe review. Still, there are claims that the drink was prepared in cafes in both New Zealand and Australia, as far back as the 1960s.\n\nFlat white coffee is a double shot of espresso, topped with steamed milk, but no milk foam. It has a stronger coffee taste than a latte because of the extra shot of espresso.",
  },
  {
    id: 9,
    ...
    description:
      "Cafe au Leit is coffee with milk. The first reference to the cafe au lait dates back to the late 1600s, when cafes first started appearing in Paris. Cafe au lait is simply the French term for “coffee with milk”, so this would have referred to any coffee served with milk, rather than a particular drink.\n\nEuropeans usually prepare cafe au lait with a shot of espresso topped with warm milk. Still, Americans prepare it with concentrated drip coffee, topped with steamed milk. The taste will depend on the preparation, but it will generally have a milky taste like a latte.",
  },
  {
    id: 10,
    ...
    description:
      "Irish coffee is coffee with whiskey. Chef Joe Sheridan invented Irish coffee in 1943 who worked at the Fort Payne Airbase. One night his flight was canceled due to bad weather, and Sheridan created the coffee drink to keep the passengers warm.\n\nOriginal Irish coffee is prepared with strong brewed coffee, a shot of whiskey, brown sugar, and a whipped cream topping. It has a sweet, creamy taste with strong flavors of coffee and whiskey.",
  },
  {
    id: 11,
...
// function removeStartText(item) {
//   item.remove();
// }

const changeArticle = function (event) {
  console.log(`eventTest: ${event.target.id}`);
